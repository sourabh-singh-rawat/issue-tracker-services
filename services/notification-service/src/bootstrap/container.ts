...
import { IProjectEmailService, ProjectEmailService, ProjectMemberInvitedSubscriber } from "@/features/project-email";
import { IUserEmailService, UserEmailService, UserRegisteredSubscriber } from "@/features/user-email";
import { IWorkspaceEmailService, WorkspaceEmailService, WorkspaceMemberInvitedSubscriber } from "@/features/workspace-email";
...
container.bind<UserRegisteredSubscriber>(TYPES.UserRegisteredSubscriber).to(UserRegisteredSubscriber);
container.bind<ProjectMemberInvitedSubscriber>(TYPES.ProjectMemberInvitedSubscriber).to(ProjectMemberInvitedSubscriber);
container.bind<WorkspaceMemberInvitedSubscriber>(TYPES.WorkspaceMemberInvitedSubscriber).to(WorkspaceMemberInvitedSubscriber);
