...
ALTER TABLE "attachment_uploads" ADD COLUMN "operation_id" uuid;--> statement-breakpoint
ALTER TABLE "attachment_uploads" ADD COLUMN "metadata" jsonb;--> statement-breakpoint
ALTER TABLE "attachments" ADD COLUMN "operation_id" uuid;--> statement-breakpoint
ALTER TABLE "attachments" ADD COLUMN "metadata" jsonb;--> statement-breakpoint
