...
/**
 * CloudEvents 1.0 context attributes (JSON structured mode).
...
/**
 * Spec compliance suite for CloudEvents 1.0 (JSON structured mode).
 * @see https://github.com/cloudevents/spec/blob/v1.0.2/cloudevents/spec.md
 * @see https://github.com/cloudevents/spec/blob/v1.0.2/cloudevents/formats/json-format.md
 */
describe("CloudEvents 1.0 compliance", () => {
  describe("REQUIRED context attributes (id, source, specversion, type)", () => {
    it("createCloudEvent always produces all four REQUIRED attributes", () => {
    ...
    it.each(["id", "source", "type"] as const)(
  ...
  describe("spec example (JSON format)", () => {
    /**
     * Adapted from the CloudEvents JSON format examples.
     * @see https://github.com/cloudevents/spec/blob/v1.0.2/cloudevents/formats/json-format.md#3-examples
     */
    it("accepts the canonical JSON structured-mode example shape", () => {
      const example = {
        specversion: "1.0",
        type: "com.github.pull_request.opened",
