...
export const startOidcSignIn = async (): Promise<string> => {
  ...
  authorizeUrl.searchParams.set("client_id", import.meta.env.VITE_ADMIN_WEB_OIDC_CLIENT_ID);
  authorizeUrl.searchParams.set("redirect_uri", import.meta.env.VITE_ADMIN_WEB_OIDC_REDIRECT_URI);
