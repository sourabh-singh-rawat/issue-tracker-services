...
export default function WorkspaceDescription({ form, defaultSchemas, handleSubmit }: Props) {
    ...
    <>
      <Grid container>
        <Grid item xs={5}>
          ...
          <Typography variant="body2">A description for your workspace</Typography>
        </Grid>
