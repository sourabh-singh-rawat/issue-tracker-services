...
export type ClientOptions = {
    baseURL: `${string}://${string}` | 'http://localhost:4001' | 'http://localhost:4001' | 'http://localhost:4001' | 'http://localhost:4001' | 'http://localhost:4001' | 'http://localhost:4001' | 'http://localhost:4003' | (string & {});
};
