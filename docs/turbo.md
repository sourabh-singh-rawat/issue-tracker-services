...
| ------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| `@pine/*`                                                                                                                       | `packages/*` |
| `@pine/identity-service`, `@pine/attachment-service`, `@pine/notification-service`, `@pine/issues-service`, `@pine/api-gateway` | `services/*` |
| `@pine/erp-web`, `@pine/identity-web`                                                                                           | `apps/*`     |
...
pnpm exec turbo run dev --filter=@pine/erp-web
...
```bash
pnpm exec turbo run build test --filter=...[<base>] --filter=!@pine/erp-web
```
...
- `@pine/erp-web` excluded until its typecheck is green
